...
function defaultState() {
  return { week: DAYS.map(d=>({day:d,name:'',type:'rest',exercises:[]})), logs:{}, done:{}, notes:{}, savedWeeks:{}, wellness:{}, periodization:{enabled:false,anchor:null,weeks:{A:null,B:null,C:null}} };
}
function loadState() { try { return JSON.parse(localStorage.getItem('sbt6')) || defaultState(); } catch(e) { return defaultState(); } }
function saveState() { localStorage.setItem('sbt6', JSON.stringify(S)); }
...
let S = (function(){
  ...
  // Garde localStorage seulement si version 6+ ET données réelles
  if(stored && stored.week && stored.week.length === 7 && stored._version >= 6 &&
     (Object.keys(stored.logs||{}).length > 0 || Object.keys(stored.done||{}).length > 0)) return stored;
  // Sinon nettoie et charge le programme embarqué
  try { localStorage.removeItem('sbt6'); } catch(e){}
  var embedded = {"week": [{"day": "Lundi", "name": "PUSH 1", "type": "push", "exercises": [{"name": "Développé haltères (Pectoraux, Épaules avant)", "sets": 4, "reps": 8, "weight": 12, "rest": 150, "notes": "1-2 RIR. Compound lourd, vise la surcharge progressive.", "media": [], "barWeight": 4.5, "discsWeight": 7.5}, {"name": "Développé militaire haltères (Épaules globales)", "sets": 3, "reps": 10, "weight": 10, "rest": 150, "notes": "1-2 RIR. Compound épaules, ordre corrigé.", "media": [], "barWeight": 4.5, "discsWeight": 5.5}, {"name": "Dips (Pectoraux, Triceps)", "sets": 3, "reps": 8, "weight": 0, "rest": 120, "notes": "Lest si tu fais >10 reps facile. 1-2 RIR.", "media": []}, {"name": "Élévations latérales (Épaules côté)", "sets": 3, "reps": 12, "weight": 5, "rest": 90, "notes": "Repos corrigé 60→90s. Reps stables sur les 3 séries.", "media": [], "barWeight": 4.5, "discsWeight": 0.5}, {"name": "Écartés haltères couché (Pectoraux - Étirement)", "sets": 3, "reps": 12, "weight": 6, "rest": 90, "notes": "Range de mouvement complet, étirement profond.", "media": [], "barWeight": 4.5, "discsWeight": 1.5}, {"name": "Barre EZ serrée (Triceps)", "sets": 3, "reps": 10, "weight": 10, "rest": 90, "notes": "Triceps lourd compound. 1-2 RIR.", "media": [], "barWeight": 4.5, "discsWeight": 5.5}]}, {"day": "Mardi", "name": "PULL 1", "type": "pull", "exercises": [{"name": "Tractions (Dos largeur, Biceps)", "sets": 4, "reps": 6, "weight": 0, "rest": 150, "notes": "Si <6 reps : assisté avec élastique. Si >10 : ajoute lest.", "media": []}, {"name": "Rowing haltères penché (Dos épaisseur)", "sets": 3, "reps": 10, "weight": 14, "rest": 150, "notes": "1-2 RIR. Tire avec les coudes vers les hanches.", "media": [], "barWeight": 4.5, "discsWeight": 9.5}, {"name": "Rowing barre EZ (Dos épaisseur globale)", "sets": 3, "reps": 10, "weight": 15, "rest": 150, "notes": "1-2 RIR. Dos droit, contracte les omoplates.", "media": [], "barWeight": 4.5, "discsWeight": 10.5}, {"name": "Facepull poulie haute (Épaules arrière)", "sets": 3, "reps": 15, "weight": 7, "rest": 90, "notes": "Repos corrigé 60→90s. Essentiel pour posture (agent sécu).", "media": [], "barWeight": 4.5, "discsWeight": 2.5}, {"name": "Curl EZ (Biceps)", "sets": 3, "reps": 10, "weight": 10, "rest": 90, "notes": "1-2 RIR. Coudes fixes.", "media": [], "barWeight": 4.5, "discsWeight": 5.5}, {"name": "Curl marteau haltères (Biceps, Avant-bras)", "sets": 3, "reps": 12, "weight": 10, "rest": 90, "notes": "Brachial + avant-bras.", "media": [], "barWeight": 4.5, "discsWeight": 5.5}]}, {"day": "Mercredi", "name": "LEGS 1", "type": "legs", "exercises": [{"name": "Squat haltère (Cuisses avant, Fesses)", "sets": 4, "reps": 8, "weight": 16, "rest": 150, "notes": "Compound roi. 1-2 RIR. Repos long.", "media": [], "barWeight": 4.5, "discsWeight": 11.5}, {"name": "Hip thrust barre EZ (Fesses)", "sets": 4, "reps": 10, "weight": 20, "rest": 150, "notes": "1-2 RIR. Contracte 1s en haut.", "media": [], "barWeight": 4.5, "discsWeight": 15.5}, {"name": "Soulevé de terre jambes tendues (Arrière-cuisses)", "sets": 3, "reps": 10, "weight": 20, "rest": 150, "notes": "1-2 RIR. Dos neutre, étire les ischios.", "media": [], "barWeight": 4.5, "discsWeight": 15.5}, {"name": "Fente marchée (Cuisses avant, Fesses)", "sets": 3, "reps": 10, "weight": 6, "rest": 120, "notes": "10 reps par jambe.", "media": [], "barWeight": 4.5, "discsWeight": 1.5}, {"name": "Leg extension maison (Cuisses avant - Isolation)", "sets": 3, "reps": 15, "weight": 6, "rest": 90, "notes": "Repos corrigé 60→90s. Contraction max en haut.", "media": [], "barWeight": 4.5, "discsWeight": 1.5}, {"name": "Mollets debout haltère (Mollets)", "sets": 4, "reps": 15, "weight": 12, "rest": 90, "notes": "Repos corrigé 60→90s. Range complet.", "media": [], "barWeight": 4.5, "discsWeight": 7.5}]}, {"day": "Jeudi", "name": "REPOS", "type": "rest", "exercises": []}, {"day": "Vendredi", "name": "PUSH 2", "type": "push", "exercises": [{"name": "Développé incliné haltères (Haut des Pectoraux)", "sets": 4, "reps": 8, "weight": 10, "rest": 150, "notes": "🔥 EXO PRIORITAIRE. Était en 3e position, maintenant en 1er. 1-2 RIR.", "media": [], "barWeight": 4.5, "discsWeight": 5.5}, {"name": "Développé militaire EZ (Épaules avant, Triceps)", "sets": 4, "reps": 8, "weight": 10, "rest": 150, "notes": "1-2 RIR. Compound épaules.", "media": [], "barWeight": 4.5, "discsWeight": 5.5}, {"name": "Dips (Pectoraux, Triceps)", "sets": 3, "reps": 8, "weight": 0, "rest": 120, "notes": "Lest si trop facile.", "media": []}, {"name": "Écarté incliné (Haut des Pectoraux - Étirement)", "sets": 3, "reps": 12, "weight": 5, "rest": 90, "notes": "Repos corrigé 60→90s. Étirement maximal en bas.", "media": [], "barWeight": 4.5, "discsWeight": 0.5}, {"name": "Élévations latérales (Épaules côté)", "sets": 3, "reps": 12, "weight": 5, "rest": 90, "notes": "Repos corrigé 60→90s. Plus en fin de séance maintenant.", "media": [], "barWeight": 4.5, "discsWeight": 0.5}, {"name": "Overhead triceps haltère (Triceps - Longue portion)", "sets": 3, "reps": 12, "weight": 8, "rest": 90, "notes": "Étirement long head. 1-2 RIR.", "media": [], "barWeight": 4.5, "discsWeight": 3.5}]}, {"day": "Samedi", "name": "PULL 2", "type": "pull", "exercises": [{"name": "Tirage poulie haute grip large (Dos largeur)", "sets": 4, "reps": 10, "weight": 0, "rest": 150, "notes": "1-2 RIR. Tire vers la poitrine, contracte les omoplates.", "media": []}, {"name": "Rowing unilatéral (Dos épaisseur par côté)", "sets": 3, "reps": 10, "weight": 0, "rest": 120, "notes": "10 reps par côté. 1-2 RIR.", "media": []}, {"name": "Shrugs (Trapèzes - Le cou de justicier)", "sets": 3, "reps": 12, "weight": 0, "rest": 90, "notes": "Contracte 1s en haut. Bon pour posture agent sécu.", "media": []}, {"name": "Facepull (Épaules arrière, Posture)", "sets": 3, "reps": 15, "weight": 0, "rest": 90, "notes": "Posture, anti-enroulé.", "media": []}, {"name": "Curl EZ prises différentes (Biceps globaux)", "sets": 3, "reps": 10, "weight": 0, "rest": 90, "notes": "Alterne prise large/serrée selon séries.", "media": []}, {"name": "Curl marteau lent (Avant-bras)", "sets": 3, "reps": 12, "weight": 0, "rest": 90, "notes": "Tempo 2s descente. Brachial + avant-bras.", "media": []}]}, {"day": "Dimanche", "name": "LEGS 2", "type": "legs", "exercises": [{"name": "Squat haltères léger (Cuisses globales)", "sets": 3, "reps": 12, "weight": 12, "rest": 150, "notes": "Volume modéré, focus technique.", "media": [], "barWeight": 4.5, "discsWeight": 7.5}, {"name": "Hip thrust lourd (Fesses - Puissance max)", "sets": 4, "reps": 8, "weight": 30, "rest": 150, "notes": "1-2 RIR. Compound roi du jour. Repos long.", "media": [], "barWeight": 4.5, "discsWeight": 25.5}, {"name": "Soulevé de terre jambes tendues (Arrière-cuisses)", "sets": 4, "reps": 10, "weight": 20, "rest": 150, "notes": "1-2 RIR. Étire bien les ischios.", "media": [], "barWeight": 4.5, "discsWeight": 15.5}, {"name": "Fente arrière (Cuisses avant, Fesses)", "sets": 3, "reps": 10, "weight": 8, "rest": 120, "notes": "10 reps par jambe. Stabilité + force.", "media": [], "barWeight": 4.5, "discsWeight": 3.5}, {"name": "Step-up (Cuisses avant, Stabilité)", "sets": 3, "reps": 10, "weight": 0, "rest": 120, "notes": "10 reps par jambe. Pose le pied complet sur le step.", "media": []}, {"name": "Mollets lent (Mollets)", "sets": 4, "reps": 15, "weight": 12, "rest": 90, "notes": "Repos corrigé 50→90s. Tempo lent, contraction max.", "media": [], "barWeight": 4.5, "discsWeight": 7.5}]}], "logs": {"0_0_2026-05-18": [{"w": 12, "r": 8, "date": "2026-05-18"}, {"w": 12, "r": 8, "date": "2026-05-18"}, {"w": 12, "r": 8, "date": "2026-05-18"}, {"w": 12, "r": 8, "date": "2026-05-18"}], "0_1_2026-05-18": [{"w": 5, "r": 15, "date": "2026-05-18"}, {"w": 5, "r": 10, "date": "2026-05-18"}, {"w": 5, "r": 7, "date": "2026-05-18"}, {"w": 5, "r": 6, "date": "2026-05-18"}], "0_2_2026-05-18": [{"w": 10, "r": 7, "date": "2026-05-18"}, {"w": 0, "r": 0, "date": "2026-05-18"}]}, "done": {}, "notes": {}, "savedWeeks": {}, "wellness": {}, "periodization": {"enabled": false, "anchor": null, "weeks": {"A": null, "B": null, "C": null}}, "_exported": "2026-05-19T04:51:01.176554Z", "_version": 7, "_notes": "Haltères vide (paire)=4.5kg · EZ vide=4.5kg · Repos standardisés 150s/120s/90s"};
...
function go(id,btn){
  ...
  if(id==='dash'){renderStats();renderVolumeDayChart();renderWeekCmp();renderStrip();renderSession();renderPerioBar('perio-dash-bar');renderDashHero();renderWeekScore();}
...
function renderDashHero(){
  ...
  try {
    ...
    if(wtData.length){ wtCurrent = parseFloat(wtData[wtData.length-1].w); }
    const wtStart = wtData.length ? parseFloat(wtData[0].w) : 65;
  ...
  el.innerHTML = sessionCard + kcalCard + poidsCard;
}
...
function renderStrip(){
  ...
  document.getElementById('strip').innerHTML=DAYS.map((d,i)=>{
    const s=S.week[i], done=S.done&&S.done[i+'_'+today];
    return`<div class="dp tp-${s.type}${curDay===i?' on':''}${done?' done':''}" onclick="selectDay(${i})">
...
function renderSession(){
  ...
  const today=todayKey();
  const isDone=S.done&&S.done[curDay+'_'+today];
  ...
  // ── Estimated duration ──
  const estSecs = s.exercises.reduce((total, ex) => {
    const setTime = 30; // ~30s per set (effort)
    const rest = ex.rest || 90;
    return total + ex.sets * setTime + (ex.sets - 1) * rest;
  }, 0);
  const estMin = Math.round(estSecs / 60);
  const estFmt = estMin >= 60 ? `${Math.floor(estMin/60)}h${String(estMin%60).padStart(2,'0')}` : `${estMin} min`;

  // ── Progress today ──
  const doneCount = s.exercises.filter((_,ei) => getLogs(curDay,ei).length > 0).length;
    ...
    <div class="sess-bar">
      <div class="sess-bar-item">
        ...
        <div class="sess-bar-body">
          ...
          <div class="sess-bar-sub">${s.exercises.length} exercices · ${s.exercises.reduce((a,ex)=>a+ex.sets,0)} séries</div>
        </div>
      </div>
      <div class="sess-bar-item">
        <div class="sess-bar-icon">⚡</div>
        ...
        <div class="done-row">
          <div style="flex:1;display:flex;flex-direction:column;gap:8px">
            <div class="wt-section" style="border-radius:8px;margin-bottom:0">
              <div class="wt-label">Ressenti du jour</div>
...
function buildPlanRow(ex,ei){
  ...
  const repsLabel=amrap?(ex.reps>0?ex.reps+'+ rép.':'AMRAP'):ex.reps+' rép.';
...
function buildActRow(ex,ei,isActive=false){
  ...
  // Status: done if all planned sets are logged with values, partial if some logs
  const validLogs=logs.filter(l=>(l.w||0)>0||(l.r||0)>0).length;
...
function buildActDetail(ex,ei,logs,diffs){
  ...
  if(prevLogs.length&&!logs.length){
    ...
    if(amrap){
      ...
      const sugW=maxW>0?(maxW+2.5):null;
      const sugR=maxR>0?maxR+1:null;
      const ex_sets=ex.sets||3;

      // Card 1 — +2.5 kg, same reps
      const card1=sugW!=null?`
        <div class="ob-card" onclick="applyOverload(${di},${ei},${sugW},${maxR})" title="Appliquer : ${sugW}kg × ${maxR} sur ${ex_sets} séries">
          <div class="ob-card-tag">+ Poids</div>
          <div class="ob-card-main">${sugW.toFixed(1)}<span style="font-size:11px;font-weight:400;color:var(--t3)">kg</span> × ${maxR}</div>
          <div class="ob-card-delta">↑ +2.5 kg</div>
          <div class="ob-card-prev">avant : ${prevFmt}</div>
          <div class="ob-card-arrow">→</div>
        </div>`:
        `<div class="ob-card" style="opacity:.35;pointer-events:none;cursor:default">
          <div class="ob-card-tag">+ Poids</div>
          <div class="ob-card-main" style="font-size:12px;color:var(--t3)">Pas de poids</div>
          <div class="ob-card-prev">exercice au poids du corps</div>
        </div>`;

      // Card 2 — same weight, +1 rep
      const card2=sugR!=null?`
        <div class="ob-card" onclick="applyOverload(${di},${ei},${maxW},${sugR})" title="Appliquer : ${maxW?maxW+'kg':''} × ${sugR} sur ${ex_sets} séries">
          <div class="ob-card-tag">+ Répétition</div>
          <div class="ob-card-main">${maxW?`${maxW}<span style="font-size:11px;font-weight:400;color:var(--t3)">kg</span> × `:''}${sugR}</div>
          <div class="ob-card-delta">↑ +1 rép.</div>
          <div class="ob-card-prev">avant : ${prevFmt}</div>
          <div class="ob-card-arrow">→</div>
        </div>`:'';
  ...
  const setRows=logs.map((l,li)=>{
    ...
    return`<div class="act-row">
      ...
      <input class="inp-sm${beat?' beat':''}" type="number" value="${l.w||''}" min="0" step="0.5" placeholder="${amrap?'kg':'kg'}"
        onchange="logChange(${di},${ei},${li},'w',this.value)"/>
      <input class="inp-sm" type="number" value="${l.r||''}" min="1" placeholder="${amrap?'max':'rép'}"
      ...
      <div class="act-vol">${vol?vol+'kg':''}</div>
  ...
  let ormHTML='';
  if(logs.length){
    const bestSet=logs.reduce((a,l)=>(((l.w||0)*(l.r||0))>((a.w||0)*(a.r||0))?l:a),logs[0]);
    const w=bestSet.w||0, r=bestSet.r||0;
    if(w>0&&r>0){
      const orm=Math.round(w*(1+r/30));
      const prevBestSet=prevLogs.length?prevLogs.reduce((a,l)=>(((l.w||0)*(l.r||0))>((a.w||0)*(a.r||0))?l:a),prevLogs[0]):{w:0,r:0};
      const prevOrm=prevBestSet.w>0&&prevBestSet.r>0?Math.round(prevBestSet.w*(1+prevBestSet.r/30)):0;
      const ormDelta=prevOrm>0?orm-prevOrm:0;
      const ormDeltaHTML=ormDelta>0?`<span style="font-size:9px;color:var(--green)">↑ +${ormDelta}kg</span>`:ormDelta<0?`<span style="font-size:9px;color:var(--red)">↓ ${ormDelta}kg</span>`:'';
      ormHTML=`<div class="orm-row">
        <div class="orm-lbl">1RM estimé</div>
        <div class="orm-val">${orm}<span style="font-size:11px;color:var(--t3)">kg</span></div>
        ${ormDeltaHTML}
        <div class="orm-sub" style="margin-left:auto">Epley : ${w}kg × (1+${r}/30)</div>
      </div>`;
    }
  }
  ...
  // ── Mini graphe historique 1RM ──
  let miniChartHTML = '';
  const allEntries2 = getAllLogs(di, ei);
  const histPoints = allEntries2.map(([k,v]) => {
    if(!v||!v.length) return null;
    const best = v.reduce((a,l)=>((l.w||0)*(l.r||0)>(a.w||0)*(a.r||0)?l:a), v[0]);
    const w=best.w||0, r=best.r||0;
    const orm = w>0&&r>0 ? Math.round(w*(1+r/30)) : 0;
    const dateParts = k.split('_').slice(2).join('_');
    return orm > 0 ? {date: dateParts, orm} : null;
  }).filter(Boolean).slice(-12); // max 12 dernières sessions

  if(histPoints.length >= 2){
    const vals = histPoints.map(p=>p.orm);
    const minV = Math.min(...vals), maxV = Math.max(...vals);
    const W=200, H=40, pad={l:2,r:2,t:4,b:4};
    const xFor = (i) => pad.l + i/(histPoints.length-1)*(W-pad.l-pad.r);
    const yFor = (v) => maxV===minV ? H/2 : pad.t+(1-(v-minV)/(maxV-minV))*(H-pad.t-pad.b);
    const pts = histPoints.map((p,i)=>`${xFor(i).toFixed(1)},${yFor(p.orm).toFixed(1)}`).join(' ');
    const last = histPoints[histPoints.length-1];
    const first = histPoints[0];
    const delta = last.orm - first.orm;
    const deltaStr = (delta>=0?'+':'')+delta+'kg';
    const deltaColor = delta>=0?'var(--green)':'var(--red)';
    miniChartHTML = `<div style="margin:8px 0;padding:8px 10px;background:var(--s3);border-radius:var(--r);border:1px solid var(--b1)">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px">
        <span style="font-family:var(--mono);font-size:8px;color:var(--t3);text-transform:uppercase;letter-spacing:.07em">1RM estimé — ${histPoints.length} sessions</span>
        <span style="font-family:var(--mono);font-size:10px;font-weight:600;color:${deltaColor}">${deltaStr}</span>
      </div>
      <svg viewBox="0 0 ${W} ${H}" style="width:100%;height:40px;display:block" xmlns="http://www.w3.org/2000/svg">
        <polyline points="${pts}" fill="none" stroke="var(--green)" stroke-width="1.5" stroke-linejoin="round"/>
        ${histPoints.map((p,i)=>`<circle cx="${xFor(i).toFixed(1)}" cy="${yFor(p.orm).toFixed(1)}" r="2" fill="var(--green)" opacity=".7"/>`).join('')}
        <circle cx="${xFor(histPoints.length-1).toFixed(1)}" cy="${yFor(last.orm).toFixed(1)}" r="3" fill="var(--green)"/>
      </svg>
      <div style="display:flex;justify-content:space-between;font-family:var(--mono);font-size:8px;color:var(--t3);margin-top:2px">
        <span>${first.date.split('-').slice(1).reverse().join('/')}</span>
        <span style="color:var(--t1);font-weight:600">${last.orm}kg</span>
        <span>${last.date.split('-').slice(1).reverse().join('/')}</span>
      </div>
    </div>`;
  }
  ...
  return`<div class="act-det open">
    ...
    <div class="rest-row">
      ...
      <select class="rest-sel" id="rsel-${di}-${ei}">
        ${[60,90,120,180,300].map(v=>`<option value="${v}"${(ex.rest||120)==v?' selected':''}>${v<60?v+'s':Math.floor(v/60)+'m'+(v%60?'30':'')}</option>`).join('')}
      </select>
...
function applyOverload(di,ei,sugW,sugR){
  ...
  if(!ex) return;
  const k=dateLogKey(di,ei,todayKey());
  S.logs[k]=Array.from({length:ex.sets},()=>({w:+sugW,r:+sugR,date:todayKey()}));
  saveState(); expandA=ei; renderSession();
  const label=sugW?`${sugW}kg × ${sugR} rép.`:`${sugR} rép.`;
  showToast(`✓ ${label} × ${ex.sets} séries pré-remplies`);
}
...
/* ── Inline widget (inside "Réalisé" column) ── */
function renderWtInline(){
  ...
  Object.keys(WT_CATS).forEach(cat => {
    const cfg = WT_CATS[cat];
    html += `<span style="font-family:var(--mono);font-size:9px;color:var(--t3);margin-right:4px;align-self:center">${cfg.icon}</span>`;
    html += buildWtPills(cat, w[cat]||0, curDay, dateStr, 'inline');
    html += `<div style="width:1px;height:18px;background:var(--b2);margin:0 3px;align-self:center"></div>`;
  });
  el.innerHTML = html;
}
...
function renderWellnessChart(){
  ...
  const metricLabel = metric==='orm' ? '1RM estimé (kg)' : 'Volume (kg)';
  const cfg = WT_CATS[cat];
  ...
  const metricTabHtml = `<div class="mtabs">
    ...
    <button class="mt${metric==='orm'?' on':''}" id="wtm-orm" onclick="setWtMetric('orm')">1RM est.</button>
  </div>`;
...
function addLog(di,ei){
  ...
  // Light haptic: single short pulse
  haptic(18);
  // Auto-start stopwatch on first log of session
  ...
  document.getElementById('mos-exos').innerHTML=_ee.map((e,i)=>`
    <div class="ee-item">
      ...
      <div class="g2">
        ...
        <div class="field"><label class="lbl">Notes</label><input class="inp" type="text" value="${esc(e.notes||'')}" placeholder="technique…" onchange="_ee[${i}].notes=this.value"/></div>
      </div>
      <div class="field" style="margin-top:4px;margin-bottom:0">
        <label class="lbl">Vidéo YouTube (URL ou ID)</label>
        <input class="inp" type="text" value="${esc(e.videoUrl||'')}" placeholder="https://youtube.com/watch?v=… ou ID court" onchange="_ee[${i}].videoUrl=this.value.trim()"/>
      </div>
    <button class="ss-link-btn ${e.supersetGroup && _ee[i+1] && _ee[i+1].supersetGroup===e.supersetGroup ? 'linked' : ''}" 
      onclick="toggleSupersetLink(${i})" 
      ${i>=_ee.length-1 ? 'style="display:none"' : ''}
      title="Grouper cet exercice avec le suivant en superset">
      ${e.supersetGroup && _ee[i+1] && _ee[i+1].supersetGroup===e.supersetGroup 
        ? '⊗ Superset avec le suivant — cliquer pour dissocier' 
        : '⊕ Lier en superset avec le suivant'}
    </button>
    </div>`).join('');
}
      ...
      <div class="graph-head">
        ...
        <div class="graph-ctrls" style="flex-wrap:wrap;gap:6px">
          ...
          <div class="mtabs">
            ...
            <button class="mt" id="mt-orm" onclick="setMetric('orm')">1RM</button>
          </div>
          <div class="mtabs">
...
function renderHistTable(wData,it,prVal,unit,trendSlope,trendR2){
  ...
  const rows=last5.map(w=>{
    ...
    return`<tr>
      ...
      <td class="mono" style="color:var(--t2)">${ormVal?ormVal+'kg':'—'}</td>
    </tr>`;
  }).join('');
  // ── Trend summary chip ──
  let trendHtml = '';
  ...
  wrap.innerHTML=`
    <div style="margin-top:16px;padding-top:14px;border-top:1px solid var(--b1)">
      ...
      <table class="hist-table">
        <thead><tr><th>Date</th><th>Poids max</th><th>Rép. max</th><th>Volume</th><th>1RM est.</th></tr></thead>
        <tbody>${rows}</tbody>
      </table>
    </div>`;
}
...
function renderPRs(){
  ...
  sumEl.innerHTML = `<div class="pr-summary-grid">
    ...
    <div class="pr-sum-card">
      <div class="pr-sum-lbl">Meilleur 1RM est.</div>
      <div class="pr-sum-val">${best1RM||'—'}<span style="font-size:12px;color:var(--t3)">${best1RM?'kg':''}</span></div>
      <div class="pr-sum-sub">tous exercices</div>
    </div>
    <div class="pr-sum-card">
  ...
  return items.map(item => {
    ...
    const histRows = histEntries.map(([k, logs]) => {
      ...
      return `<div class="pr-hist-row${isPeak?' pr-peak':''}">
        ...
        <span class="pr-hist-orm">${orm?'1RM~'+orm+'kg':''}</span>
      ...
      <div class="pr-card-main" style="border-bottom:${isOpen?'1px solid var(--b1)':'none'}">
        ...
        <div class="pr-card-metrics">
          ${item.maxW ? `<div class="pr-metric highlight">
            <div class="pr-metric-val">${item.maxW}<span style="font-size:9px;font-weight:400;color:var(--t3)">kg</span></div>
          ...
          ${item.maxVol ? `<div class="pr-metric">
            <div class="pr-metric-val">${item.maxVol}<span style="font-size:9px;font-weight:400;color:var(--t3)">kg</span></div>
            <div class="pr-metric-lbl">Vol. max</div>
          </div>` : ''}
          ${item.orm ? `<div class="pr-metric">
            <div class="pr-metric-val">${item.orm}<span style="font-size:9px;font-weight:400;color:var(--t3)">kg</span></div>
            <div class="pr-metric-lbl">1RM est.</div>
          </div>` : ''}
        </div>
      </div>
...
function renderExos(){
  ...
  sumEl.innerHTML = `<div class="exo-summary-grid">
    ...
    <div class="stat-card"><div class="stat-lbl">Meilleur 1RM</div><div class="stat-val" style="font-size:18px">${best1RM?best1RM+'kg':'—'}</div><div class="stat-sub">estimé</div></div>
  </div>`;
  ...
  function buildExoCard(item){
    ...
    const histRows = histEntries.map(([k, logs])=>{
      ...
      return `<tr class="${isPR?'exo-lib-pr-row':''}">
        ...
        <td style="color:var(--t2)">${ormV?'~'+ormV+'kg':'—'}</td>
      </tr>`;
    }).join('');
    ...
    return `<div class="exo-lib-card${_exoOpen[key]?' exo-lib-open':''}" id="exocard-${key}" onclick="toggleExoCard('${key}')">
      ...
      <div class="exo-lib-metrics">
        ...
        <div class="exo-lib-metric">
          <div class="exo-lib-mval" style="font-size:11px">${item.orm?item.orm+'kg':'—'}</div>
          <div class="exo-lib-mlbl">1RM est.</div>
        </div>
      </div>
      <div class="exo-lib-detail">
        ...
        ${hasLogs ? `<table class="exo-lib-hist">
          <thead><tr><th>Date</th><th>Séries</th><th>Poids max</th><th>Rép. max</th><th>Vol. max</th><th>1RM est.</th></tr></thead>
...
/* ═══ NUTRITION EXPORT / IMPORT ═══ */
function nutrExportJSON() {
  const payload = {
    nutrition:  S.nutrition  || {},
    nutrGoals:  S.nutrGoals  || {},
    _type:      'nutrition',
  ...
  const d    = new Date();
  const ds   = d.getFullYear()+'-'+String(d.getMonth()+1).padStart(2,'0')+'-'+String(d.getDate()).padStart(2,'0');
  a.download = 'nutrition_'+ds+'.json';
  a.click();
  URL.revokeObjectURL(url);
  showToast('Nutrition exportée ✓');
}
...
function nutrImportJSON(inp) {
  ...
  reader.onload = function(e) {
    try {
      const data = JSON.parse(e.target.result);
      if (data._type !== 'nutrition' || !data.nutrition) throw new Error('Fichier invalide');
      if (!confirm('Remplacer les données nutrition actuelles ?')) { inp.value=''; return; }
      S.nutrition = data.nutrition;
      if (data.nutrGoals) S.nutrGoals = data.nutrGoals;
      saveState();
      renderNutrition();
...
function nutrSaveGoals(){
  const kcal = parseInt(document.getElementById('nutr-goal-kcal').value)||0;
  const prot = parseInt(document.getElementById('nutr-goal-prot').value)||0;
...
function renderNutrDayCards(){
  ...
  function pctBar(val, goal, cls){
    if(!goal||val==='') return '';
    const pct = Math.min(100, Math.round((val/goal)*100));
    const over = val>goal;
    const fillCls = over ? 'nutr-progress-over' : cls;
    return `<div class="nutr-progress"><div class="nutr-progress-fill ${fillCls}" style="width:${pct}%"></div></div>
            <div class="nutr-goal-pct">${pct}% de l'objectif (${goal}${cls==='nutr-progress-kcal'?'kcal':'g'})</div>`;
  }

  el.innerHTML = `
    <div class="nutr-day-card">
      <div>
      ...
      <div class="nutr-inp-row">
        <input class="nutr-inp" type="number" min="0" step="50" placeholder="Entrer kcal…"
          value="${entry.kcal!==''?entry.kcal:''}"
          oninput="nutrSaveEntry('${dk}','kcal',this.value)"/>
      </div>
      ${goals.kcal ? pctBar(entry.kcal!==''?entry.kcal:0, goals.kcal, 'nutr-progress-kcal') : ''}
    </div>
    <div class="nutr-day-card">
      <div>
      ...
      <div class="nutr-inp-row">
        <input class="nutr-inp" type="number" min="0" step="5" placeholder="Entrer protéines…"
          value="${entry.prot!==''?entry.prot:''}"
          oninput="nutrSaveEntry('${dk}','prot',this.value)"/>
      </div>
      ${goals.prot ? pctBar(entry.prot!==''?entry.prot:0, goals.prot, 'nutr-progress-prot') : ''}
    </div>`;
}
...
(function(){
  ...
  const LS_getGoal() = 'wtGoal';
  function getGoal(){ return parseFloat(localStorage.getItem(LS_getGoal())||'83')||83; }
  function getPaliers(g){ 
    const start = 60; const steps = 6;
    const arr = [];
...
(function(){
  ...
  function compute(){
    ...
    // ── Macros dynamiques selon poids (ectomorphe) ──
    // Protéines : 2.2g/kg (fixe)
    // Glucides base : 6g/kg → riz + flocons + pain
    // Lipides : 1.3g/kg → huile + beurre cacahuète
    // Calories base = (prot*4) + (gluc*4) + (lip*9)
    const protJour   = Math.round(poids * 2.2);          // g
    const glucBase   = Math.round(poids * 6);            // g
    const lipJour    = Math.round(poids * 1.3);          // g
    const kcalBase   = Math.round(protJour*4 + glucBase*4 + lipJour*9);

    // Surplus = 100% glucides (riz en priorité, flocons ensuite)
    const extraKcal   = surplus;
    const extraGlucG  = Math.round(extraKcal / 4);       // g de glucides supplémentaires
    const extraRiz    = surplus <= 0 ? 0 : surplus <= 200 ? 50 : surplus <= 400 ? 100 : 80;
    const extraFlocon = surplus <= 400 ? 0 : 40;

    // Quantités de base recalculées selon poids
    // Riz CRU base = glucBase - 100(flocons) - 100(pain) = restant / 1 (riz = 1g gluc/g CRU environ)
    // Simplification : on garde les ratios proportionnels au poids vs 65kg ref
    const ratioP     = poids / 65;
    // Glucides : riz + flocons + pain proportionnels au poids
    const rizBase    = Math.round(260 * ratioP);
    const floconBase = Math.round(100 * ratioP);
    const laitBase   = Math.round(600 * ratioP);
    // Whey : 3 scoops (90g) à 65kg, scale avec les protéines
    // 3 scoops = ~75g protéines. Le reste vient de la viande (~100-140g prot/200g viande)
    const wheyBase   = Math.round(90 * ratioP);
    const bcpBase    = Math.round(30 * ratioP);
    const painBase   = Math.round(100 * ratioP);
    const legumBase  = 400;
    const huileBase  = Math.round(60 * ratioP);

    // Jeudi = repos → pas de surplus, base seulement
    const now = new Date();
    ...
    let t = { flocons:0, lait:0, whey:0, bcp:0, pain:0, poulet:0, boeuf:0, oeufs:0, lardons:0, riz:0, legumes:0, huile:0 };

    includedDays.forEach(function(date){
      const dow = date.getDay();
      const idx = dow === 0 ? 6 : dow - 1;
      const plan = WEEK_PLAN[idx];
      const isRest   = (dow === 4); // Jeudi
      const rizDay    = isRest ? rizBase : rizBase + extraRiz;
      const floconDay = isRest ? floconBase : floconBase + extraFlocon;
      // Viandes : proportionnelles au poids, fixes peu importe le surplus
      const pouletDay = Math.round(plan.poulet * ratioP);
      const boeufDay  = Math.round(plan.boeuf  * ratioP);
      t.flocons  += floconDay;
      t.lait     += laitBase;
      t.whey     += wheyBase;
      t.bcp      += bcpBase;
    ...
    if(macrosHint){
      macrosHint.textContent = kcalBase+' kcal base · '+protJour+'g prot · '+glucBase+'g gluc · '+lipJour+'g lip';
    }
    const hint = document.getElementById('sc-kcal-hint');
    if(hint){
      if(surplus > 0){
        const hintParts = [];
        if(extraRiz > 0)    hintParts.push('riz +'+extraRiz+'g');
        if(extraFlocon > 0) hintParts.push('flocons +'+extraFlocon+'g');
        hint.textContent = '+'+surplus+' kcal surplus (training) — '+hintParts.join(' · ')+' · Jeudi : base';
      } else {
        hint.textContent = 'Jeudi repos : base seulement';
      }
    }
    ...
    let viandeRows = '';
    if(t.poulet > 0) viandeRows += row('Blanc de poulet', toKg(t.poulet));
    if(t.boeuf  > 0) viandeRows += row('Bœuf haché 15%',  toKg(t.boeuf));
    if(t.lardons> 0) viandeRows += row('Lardons',          toKg(t.lardons));
    if(viandeRows) html += card('Viandes', 'var(--pull)', viandeRows);

    let protRows = row('Whey', toKg(t.whey) + ' (~'+ Math.ceil(t.whey/30) +' scoops)');
    if(t.oeufs > 0) protRows += row('Œufs', t.oeufs + ' unités');
    html += card('Whey & œufs', 'var(--green)', protRows);

    let glucRows = row('Flocons avoine CRU', toKg(t.flocons))
      + row('Riz basmati CRU', toKg(t.riz))
      + row('Pain complet', toKg(t.pain));
    html += card('Glucides', 'var(--push)', glucRows);

    let divRows = row('Lait d\'avoine', toLt(t.lait))
      + row('Légumes surgelés', toKg(t.legumes))
      + row('Huile d\'olive', toLt(t.huile))
      + row('Beurre de cacahuète', toKg(t.bcp));
  ...
  function init(){
    ...
    document.getElementById('sc-poids').addEventListener('change', function(){ localStorage.setItem('scPoids', this.value); });
...
(function(){
  ...
  function calcMacros(){
    ...
    // BMR Mifflin-St Jeor (homme, 25 ans, 175cm — ajustable)
    const bmr  = 10 * poids + 6.25 * 175 - 5 * 25 + 5;
  ...
  function buildDayMeals(macros, dayType){
    const { kcal, prot, gluc, lip } = macros;

    // Répartition par repas (%) selon training ou repos
    const isTraining = dayType !== 'rest';
    const splits = isTraining
      ? { reveil: .23, dejeuner: .32, pretraining: .13, diner: .32 }
      : { reveil: .23, dejeuner: .32, snack: .13, diner: .32 };

    // Quantités des aliments (g) calculées proportionnellement
    // Protéines : whey 25g prot/30g, poulet 22g/100g, boeuf 17g/100g, oeufs 6g/oeuf
    // Glucides  : avoine 60g/100g, riz 78g/100g, pain complet 44g/100g
    // Lipides   : huile 100g/100g, bcp 25g/30g

    const protReveil   = Math.round(prot * splits.reveil);
    const protDej      = Math.round(prot * splits.dejeuner);
    const protPre      = Math.round(prot * (isTraining ? splits.pretraining : splits.snack));
    const protDiner    = prot - protReveil - protDej - protPre;

    // Avoine petit-déj (protReveil = 35% whey + reste avoine)
    const wheyReveil = Math.round(protReveil * 0.55 / 0.83); // 30g whey = 25g prot
    const avoineG    = Math.round((protReveil - wheyReveil * 0.83) / 0.13 * 1.1);
    const laitAvoineReveil = 350;

    // Source protéine déjeuner (alterne selon jour)
    const srcDej = ['poulet','boeuf','oeufs','poulet','boeuf','boeuf','poulet'][['push','pull','legs','rest','push','pull','legs'].indexOf(dayType)] || 'poulet';
    const qProtDej = srcDej === 'poulet' ? Math.round(protDej / 0.22)
                   : srcDej === 'boeuf'  ? Math.round(protDej / 0.17)
                   : Math.round(protDej / 0.12);

    // Riz déjeuner
    const glucDej = Math.round(gluc * splits.dejeuner);
    const rizDej  = Math.round(glucDej / 0.78);

    // Pré-training
    const wheyPre = Math.round(protPre * 0.6 / 0.83);
    const painPre = Math.round((protPre - wheyPre * 0.83) / 0.09);

    // Dîner
    const srcDiner = srcDej === 'poulet' ? 'boeuf' : 'poulet';
    const qProtDiner = srcDiner === 'poulet' ? Math.round(protDiner / 0.22) : Math.round(protDiner / 0.17);
    const glucDiner  = Math.round(gluc * splits.diner);
    const rizDiner   = Math.round(glucDiner / 0.78);
    const huile      = Math.round(lip * splits.diner * 9 / 9 * 0.4); // ~40% lipides diner = huile

    const kcalReveil = Math.round(kcal * splits.reveil);
    const kcalDej    = Math.round(kcal * splits.dejeuner);
    const kcalPre    = Math.round(kcal * (isTraining ? splits.pretraining : splits.snack));
    const kcalDiner  = kcal - kcalReveil - kcalDej - kcalPre;

    const srcDejLabel   = srcDej   === 'poulet' ? 'poulet' : srcDej === 'boeuf' ? 'bœuf haché 15%' : '4 œufs + lardons';
    const srcDinerLabel = srcDiner === 'poulet' ? 'poulet' : 'bœuf haché 15%';

    const nomRepas3 = isTraining ? 'Pré-training' : 'Snack';
    ...
    return [
      {
        ...
        prot: protReveil,
        items: [
          `${Math.max(80,avoineG)}g flocons avoine CRU + ${laitAvoineReveil}ml lait d'avoine`,
          `${Math.max(25,wheyReveil)}g whey dans le bol`,
      ...
      },
      {
        ...
        prot: protDej,
        items: [
          `${Math.max(150,qProtDej)}g ${srcDejLabel} CRU`,
          `${Math.max(100,rizDej)}g riz basmati CRU`,
          `200g légumes surgelés`,
          ...(srcDej !== 'oeufs' ? ['1 c.s. huile d\'olive'] : [])
        ]
      },
      {
        name: nomRepas3,
        ...
        prot: protPre,
        items: [
          `${Math.max(80,painPre)}g pain complet`,
          `${Math.max(25,wheyPre)}g whey + 250ml lait d'avoine`
        ]
      },
      {
        name: 'Dîner',
        ...
        prot: protDiner,
        items: [
          `${Math.max(150,qProtDiner)}g ${srcDinerLabel} CRU`,
          `${Math.max(100,rizDiner)}g riz basmati CRU`,
          `${Math.max(1,huile)} c.s. huile d'olive`,
          `200g légumes surgelés`
        ]
      }
    ];
  ...
  function bindEvents(){
    ...
    // Re-calcule quand poids ou surplus changent
    ['sc-poids','sc-kcal','sc-poids-cible'].forEach(id=>{
