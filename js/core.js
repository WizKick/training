...
function defaultState() {
  return { week: DAYS.map(d=>({day:d,name:'',type:'rest',exercises:[]})), logs:{}, done:{}, notes:{}, savedWeeks:{}, wellness:{}, periodization:{enabled:false,anchor:null,weeks:{A:null,B:null,C:null}}, nutrition:{}, nutrGoals:{}, _version:11 };
}
function loadState() { try { return JSON.parse(localStorage.getItem('sbt6')) || defaultState(); } catch(e) { return defaultState(); } }
function saveState() { if(S && !S._version) S._version = 11; safeSetItem('sbt6', JSON.stringify(S)); if(typeof scheduleSyncPush==='function') scheduleSyncPush(); }
...
let S = (function(){
  ...
  var embedded = {"week": [{"day": "Lundi", "name": "PUSH 1", "type": "push", "exercises": [{"name": "Développé haltères (Pectoraux, Épaules avant)", "reps": 10, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Pectoraux/épaules. Garde 2-3 reps en réserve, focus technique.", "weight": 16.5, "repRange": "8-12 reps"}, {"name": "Développé militaire haltères (Épaules globales)", "reps": 10, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Épaules. Démarre léger, ne cambre pas le bas du dos.", "weight": 14.5, "repRange": "8-12 reps"}, {"name": "Dips (Pectoraux, Triceps)", "reps": 8, "rest": 120, "sets": 3, "media": [], "notes": "RIR 2-3. Si trop dur : dips assistés (élastique/pieds au sol). Si >12 facile : ajoute du lest.", "weight": 0, "repRange": "6-10 reps"}, {"name": "Élévations latérales (Épaules côté)", "reps": 14, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Léger, monte coudes>poignets, pas d'élan.", "weight": 10.5, "repRange": "12-15 reps"}, {"name": "Écartés haltères couché (Pectoraux - Étirement)", "reps": 14, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Étirement contrôlé, pas de charge lourde.", "weight": 12.5, "repRange": "12-15 reps"}, {"name": "Barre EZ serrée (Triceps)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Triceps. Coudes serrés.", "weight": 14.5, "repRange": "10-12 reps"}]}, {"day": "Mardi", "name": "PULL 1", "type": "pull", "exercises": [{"name": "Tractions (Dos largeur, Biceps)", "reps": 6, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Débutant : assisté élastique ou tirage si <5 reps. Priorité technique.", "weight": 0, "repRange": "5-8 reps (ou assisté)"}, {"name": "Rowing haltères penché (Dos épaisseur)", "reps": 12, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Dos plat, tire vers les hanches. Démarre léger pour sentir le dos.", "weight": 20.5, "repRange": "10-12 reps"}, {"name": "Rowing barre EZ (Dos épaisseur globale)", "reps": 12, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Dos neutre, contracte les omoplates.", "weight": 20.5, "repRange": "10-12 reps"}, {"name": "Facepull poulie haute (Épaules arrière)", "reps": 15, "rest": 90, "sets": 3, "media": [], "notes": "RIR 3. Posture. Léger, mouvement lent et propre.", "weight": 5, "repRange": "15-20 reps"}, {"name": "Curl EZ (Biceps)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Coudes fixes, pas d'élan.", "weight": 14.5, "repRange": "10-12 reps"}, {"name": "Curl marteau haltères (Biceps, Avant-bras)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Brachial + avant-bras.", "weight": 14.5, "repRange": "12-15 reps"}]}, {"day": "Mercredi", "name": "LEGS 1", "type": "legs", "exercises": [{"name": "Squat haltère (Cuisses avant, Fesses)", "reps": 10, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Roi des jambes. Descends contrôlé, genoux dans l'axe. Démarre léger.", "weight": 10.25, "repRange": "8-12 reps"}, {"name": "Hip thrust haltère (Fesses)", "reps": 12, "rest": 120, "sets": 3, "media": [], "notes": "RIR 2-3. Dos calé sur le canapé/lit, haltère tenu sur les hanches (coussin). Pas de barre qui roule ni de banc qui glisse. Pousse sur les talons, contracte 1s en haut, menton rentré.", "weight": 12.25, "repRange": "10-12 reps"}, {"name": "Fente marchée (Cuisses avant, Fesses)", "reps": 20, "rest": 120, "sets": 3, "media": [], "notes": "RIR 2-3. Compte le NOMBRE TOTAL DE PAS (1 pas = 1 jambe). Ex : 20 pas = 10 par jambe. Note le total dans 'répétitions'. Stabilité d'abord.", "weight": 12.5, "repRange": "16-24 pas (total)"}, {"name": "Leg curl haltère couché (Ischios - Flexion)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. À PLAT VENTRE, un haltère léger serré entre les pieds (semelles). Fléchis les genoux pour ramener les talons vers les fesses, contrôle la descente. Démarre TRÈS léger (l'haltère peut glisser), pose une serviette/coussin sous les hanches.", "weight": 6.25, "repRange": "10-12 reps"}, {"name": "Leg extension haltère assis (Cuisses avant - Isolation)", "reps": 15, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. ASSIS sur une chaise/banc, un haltère léger serré entre les pieds. Tends les jambes à l'horizontale, contraction des quadris en haut 1s, descente contrôlée. Charge légère, focus sensation quadriceps.", "weight": 6.25, "repRange": "15-20 reps"}, {"name": "Mollets debout haltère (Mollets - Gastrocnémiens)", "reps": 15, "rest": 75, "sets": 4, "media": [], "notes": "RIR 2-3. AJOUT 1 série (4 au lieu de 3). Amplitude complète, pause en bas.", "weight": 10.25, "repRange": "15-20 reps"}]}, {"day": "Jeudi", "name": "REPOS", "type": "rest", "exercises": []}, {"day": "Vendredi", "name": "PUSH 2", "type": "push", "exercises": [{"name": "Développé incliné haltères (Haut des Pectoraux)", "reps": 10, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Haut des pecs. Banc 30°, démarre léger.", "weight": 14.5, "repRange": "8-12 reps"}, {"name": "Développé militaire EZ (Épaules avant, Triceps)", "reps": 10, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Épaules/triceps. Gainage serré.", "weight": 14.5, "repRange": "8-12 reps"}, {"name": "Dips (Pectoraux, Triceps)", "reps": 8, "rest": 120, "sets": 3, "media": [], "notes": "RIR 2-3. Si trop dur : dips assistés (élastique/pieds au sol). Si >12 facile : ajoute du lest.", "weight": 0, "repRange": "6-10 reps"}, {"name": "Écarté incliné (Haut des Pectoraux - Étirement)", "reps": 14, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Étirement haut des pecs, léger.", "weight": 12.5, "repRange": "12-15 reps"}, {"name": "Élévations latérales (Épaules côté)", "reps": 14, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Léger, monte coudes>poignets, pas d'élan.", "weight": 10.5, "repRange": "12-15 reps"}, {"name": "Overhead triceps haltère (Triceps - Longue portion)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Longue portion triceps, étirement contrôlé.", "weight": 8.25, "repRange": "12-15 reps"}]}, {"day": "Samedi", "name": "PULL 2", "type": "pull", "exercises": [{"name": "Tirage poulie haute grip large (Dos largeur)", "reps": 12, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Règle la pile. Tire vers la poitrine, omoplates serrées.", "weight": 0, "repRange": "10-12 reps"}, {"name": "Rowing unilatéral (Dos épaisseur par côté)", "reps": 12, "rest": 120, "sets": 3, "media": [], "notes": "RIR 2-3. 10-12 par côté, dos stable.", "weight": 8.25, "repRange": "10-12 reps/côté"}, {"name": "Shrugs (Trapèzes)", "reps": 15, "rest": 90, "sets": 4, "media": [], "notes": "RIR 2-3. AJOUT 1 série trapèzes (4 au lieu de 3). Contracte 1s en haut, pas de rotation.", "weight": 20.5, "repRange": "12-15 reps"}, {"name": "Facepull (Épaules arrière, Posture)", "reps": 15, "rest": 90, "sets": 3, "media": [], "notes": "RIR 3. Posture anti-enroulé, léger.", "weight": 5, "repRange": "15-20 reps"}, {"name": "Curl EZ prises différentes (Biceps globaux)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Alterne prise large/serrée.", "weight": 14.5, "repRange": "10-12 reps"}, {"name": "Curl marteau lent (Biceps, Avant-bras)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. Tempo 2s descente.", "weight": 14.5, "repRange": "12-15 reps"}]}, {"day": "Dimanche", "name": "LEGS 2", "type": "legs", "exercises": [{"name": "Soulevé de terre jambes tendues (Ischios, Fessiers)", "reps": 10, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Dos NEUTRE absolument. Gros mouvement ischios/fessiers. Étire bien, charge modérée.", "weight": 24.5, "repRange": "8-12 reps"}, {"name": "Squat haltères (Cuisses globales)", "reps": 10, "rest": 150, "sets": 3, "media": [], "notes": "RIR 2-3. Descends contrôlé, genoux dans l'axe.", "weight": 20.5, "repRange": "8-12 reps"}, {"name": "Hip thrust haltère (Fesses - Puissance)", "reps": 10, "rest": 120, "sets": 3, "media": [], "notes": "RIR 2-3. Dos calé canapé/lit, haltère sur les hanches (coussin pour le confort). Charge progressive vers le lourd. Pousse sur les talons, contraction 1s en haut.", "weight": 14.25, "repRange": "8-12 reps"}, {"name": "Leg curl haltère couché (Ischios - Flexion)", "reps": 12, "rest": 90, "sets": 3, "media": [], "notes": "RIR 2-3. À PLAT VENTRE, un haltère léger serré entre les pieds (semelles). Fléchis les genoux pour ramener les talons vers les fesses, contrôle la descente. Démarre TRÈS léger (l'haltère peut glisser), pose une serviette/coussin sous les hanches.", "weight": 6.25, "repRange": "10-12 reps"}, {"name": "Fente arrière (Cuisses avant, Fesses)", "reps": 20, "rest": 120, "sets": 3, "media": [], "notes": "RIR 2-3. Compte le NOMBRE TOTAL DE PAS (1 recul = 1 pas, 1 jambe). Ex : 20 pas = 10 par jambe. Note le total dans 'répétitions'.", "weight": 14.5, "repRange": "16-24 pas (total)"}, {"name": "Mollets assis/lent (Mollets - Soléaire)", "reps": 15, "rest": 75, "sets": 4, "media": [], "notes": "RIR 2-3. AJOUT 1 série. Tempo lent, contraction max. Assis cible le soléaire.", "weight": 10.25, "repRange": "15-20 reps"}]}], "logs": {}, "done": {}, "notes": {}, "savedWeeks": {}, "wellness": {}, "periodization": {"enabled": false, "anchor": null, "weeks": {"A": null, "B": null, "C": null}}, "nutrition": {}, "nutrGoals": {}, "_version": 11, "_notes": "Profil DÉBUTANT ECTOMORPHE 1m83/66->83kg, hypertrophie · 6j PPLx2 · RIR 2-3 · TOUT À LA MAISON · Convention poids = POIDS TOTAL SOULEVÉ (barre/haltère à vide inclus) · Haltère à vide 2.25kg, EZ 4.5kg, barre droite 10kg · v11: unification poids total"};
  ...
  if(stored && stored.week && stored.week.length === 7){
    ...
    // Migration v10→v11 : unification convention poids (disques → total soulevé)
    if(!stored._version){ stored._version = embedded._version; }
    if((stored._version||0) < 11 && stored.logs){
      // Migre les l.w anciens (disques) → poids total (l.w + barre à vide)
      // On ne peut pas connaître l'équipement sans l'exercice, donc on marque la migration
      // et on laisse l'utilisateur vérifier ses PRs. Les nouvelles saisies seront correctes.
      try {
        Object.values(stored.logs).forEach(function(sets){
          if(!Array.isArray(sets)) return;
          sets.forEach(function(l){
            if(l && l.w > 0 && !l._migrated){
              // Approximation prudente : +2.25 (haltère à vide) comme base
              // L'utilisateur devra corriger si c'est une barre EZ
              l.w = Math.round((l.w + 2.25) * 10) / 10;
              l._migrated = true;
            }
          });
        });
        stored._version = 11;
        localStorage.setItem('sbt6', JSON.stringify(stored));
      } catch(e){}
    }
